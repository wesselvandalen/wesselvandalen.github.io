...
function renderText() {
    ...
    document.getElementById('about-description').innerHTML =
        ...
        <br><br>
        Ik ben erg enthousiast als het gaat om IT, ben altijd op de hoogte van de laatste nieuwtjes en ben erg leergierig. Ik vind het daarom ook leuk om op allerlei verschillende vlakken werkend te zijn, en vind afwisseling
