...
export default function SidePanel() {
    ...
    return (
        <div className="panel-container">
            ...
            <nav className={`panel-nav ${isMenuOpen ? 'open' : ''}`}>
                ...
                <div className="panel-content panel-chapters">
                ...
                <div className="panel-content panel-socials" style={{ display: `${(isMenuOpen || width > 1080) ? 'flex' : 'none'}` }}>
