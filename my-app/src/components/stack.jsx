    ...
    return (
        <div className="stack-container" id='stack'>
            <div className="stack-content">
                ...
                <h3>Stack</h3>
                <p>Software & physical products I use.</p>

                <div className="stack-innhold">
                    <p className='section-title'>FRONT END</p>
                ...
                <div className="stack-innhold">
                    <p className='section-title'>BACK END</p>
                ...
                <div className="stack-innhold">
                    <p className='section-title'>{translation('stack.tools')}</p>
